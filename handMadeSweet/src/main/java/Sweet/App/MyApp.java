...
public class MyApp {
	 ...
	 public MyApp() {
        ...
        feedBacks.add(new FeedBack( "bayan" ,"I loved This product and I advise everyone to Try it","Chocolate Cake" ));
        feedBacks.add(new FeedBack( "amer" ,"I loved This product and I advise everyone to Try it","Strawberry Shortcake" ));
        feedBacks.add(new FeedBack( "amal" ,"I loved This product and I advise everyone to Try it","Brownies" ));
	...
	public void deleteFeedBack(String username, String product) {
		...
		for(FeedBack feedBack : feedBacks) {
			...
			if (feedBackToRemove != null) {
		        MyApp.recipes.remove(feedBackToRemove);
		    } else {
		        setErrorMessage("The specified feedBack does not exist");
		    }
